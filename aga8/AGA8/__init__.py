...
class AGA8Detail:
    """Class to approximate the compressibility factor, Z for a gas given its composition x, Pressure, 
    P and temperature, T using AGA8 Detail method."""

    def __init__(self, p_bara: float, t_celsius: float, x: list) -> None:
        """Initialisation."""
        # constant terms
        self.nterms = 58
        self.ncdetail = 21
